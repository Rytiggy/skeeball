...
export DISPLAY=:0
xhost +si:localuser:root  # Allow root to access the X server
xhost +local:  # This should be `+local:`, not `-local:`

# Start up the game server with sudo
sudo /home/ryan/.nvm/versions/node/v22.13.0/bin/node /home/ryan/Documents/git/skeeball/server/index.js &

# Start up the scoreboard
/home/ryan/.nvm/versions/node/v22.13.0/bin/npm --prefix /home/ryan/Documents/git/skeeball/gui run dev &  
